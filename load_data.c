...
void load_rx_mat3d(int ch, int row, int col, DATA ***rx_mat, DATA *data_in)
{
	...
	for(int i = 0; i < ch; i++)
	{
		for(int j = 0; j < col; j++)
		{
			for(int k = 0; k < row; k++)
			{
				rx_mat[i][k][j] = data_in[c]; //changed
				c++;
			}
		}
	}
...
void load_data_all(weights_t *nn_w, LUT_t *sig_lut, LUT_t *lgsm_lut)
{
	...
	// LAYER 1
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L1_0_w.txt", 32*2*5, data_in);
	load_mat3d(32, 2, 5, &(nn_w->L1_0_w), data_in);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L1_0_b.txt", 32, nn_w->L1_0_b);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L1_1_w.txt", 32, nn_w->L1_1_w);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L1_1_b.txt", 32, nn_w->L1_1_b);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L1_1_mean.txt", 32, nn_w->L1_1_mean);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L1_1_var.txt", 32, nn_w->L1_1_var);

	// LAYER 2
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L2_0_w.txt", 48*32*2, data_in);
	load_mat3d(48, 32, 2, &(nn_w->L2_0_w), data_in);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L2_0_b.txt", 48, nn_w->L2_0_b);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L2_1_w.txt", 48, nn_w->L2_1_w);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L2_1_b.txt", 48, nn_w->L2_1_b);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L2_1_mean.txt", 48, nn_w->L2_1_mean);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L2_1_var.txt", 48, nn_w->L2_1_var);
	...
	// Layer 7
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L6_0_w.txt", 1*192*1, data_in);
	load_mat3d(1, 192, 1, &(nn_w->L6_0_w), data_in);
	read_file("/home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/Weights/L6_0_b.txt", 1, nn_w->L6_0_b);
}
...
void load_rx_data_ant1(rxData_t *rx_data)
{
	...
	// RX DATA MATRIX
	read_file("home/edc/EDL_2023_200030053/DL_Receiver_C_Fixed_Rxsignal/CodeBlocks_Project/RxData/rxDataMat_Err_UAD.txt", NUM_ITEM*2*SMPL_PER_PRMB, data_in);
